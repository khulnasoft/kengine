...
// UnmarshalKenginefile sets up the CustomCertSelectionPolicy from Kenginefile tokens. Syntax:
//
//	cert_selection {
//		all_tags             <values...>
//		any_tag              <values...>
...
//	}
func (p *CustomCertSelectionPolicy) UnmarshalKenginefile(d *kenginefile.Dispenser) error {
...
// Interface guard
var _ kenginefile.Unmarshaler = (*CustomCertSelectionPolicy)(nil)
