...
func init() {
	kengine.RegisterModule(LeafFileLoader{})
}
...
func (fl *LeafFileLoader) Provision(ctx kengine.Context) error {
...
func (LeafFileLoader) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		ID:  "tls.leaf_cert_loader.file",
		New: func() kengine.Module { return new(LeafFileLoader) },
	}
}
