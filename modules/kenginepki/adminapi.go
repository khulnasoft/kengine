...
func init() {
	kengine.RegisterModule(adminAPI{})
}

// adminAPI is a module that serves PKI endpoints to retrieve
// information about the CAs being managed by Kengine.
...
func (adminAPI) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		ID:  "admin.api.pki",
		New: func() kengine.Module { return new(adminAPI) },
	}
}

// Provision sets up the adminAPI module.
func (a *adminAPI) Provision(ctx kengine.Context) error {
	a.ctx = ctx
...
func (a *adminAPI) Routes() []kengine.AdminRoute {
	return []kengine.AdminRoute{
		{
			Pattern: adminPKIEndpointBase,
			Handler: kengine.AdminHandlerFunc(a.handleAPIEndpoints),
		},
	}
}
...
// Interface guards
var (
	_ kengine.AdminRouter = (*adminAPI)(nil)
	_ kengine.Provisioner = (*adminAPI)(nil)
)
