...
func init() {
	kengine.RegisterModule(HTTPRedirectListenerWrapper{})
}
...
func (HTTPRedirectListenerWrapper) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		ID:  "kengine.listeners.http_redirect",
		New: func() kengine.Module { return new(HTTPRedirectListenerWrapper) },
	}
}
...
var (
	_ kengine.ListenerWrapper = (*HTTPRedirectListenerWrapper)(nil)
	_ kenginefile.Unmarshaler = (*HTTPRedirectListenerWrapper)(nil)
)
