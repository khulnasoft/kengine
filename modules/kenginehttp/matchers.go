...
func init() {
	kengine.RegisterModule(MatchHost{})
	kengine.RegisterModule(MatchPath{})
	kengine.RegisterModule(MatchPathRE{})
	kengine.RegisterModule(MatchMethod{})
	kengine.RegisterModule(MatchQuery{})
	kengine.RegisterModule(MatchHeader{})
	kengine.RegisterModule(MatchHeaderRE{})
	kengine.RegisterModule(new(MatchProtocol))
	kengine.RegisterModule(MatchTLS{})
	kengine.RegisterModule(MatchNot{})
}
...
func (MatchHost) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchHost) },
	}
}
...
func (MatchPath) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchPath) },
	}
}
...
func (MatchPathRE) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchPathRE) },
	}
}
...
func (MatchMethod) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchMethod) },
	}
}
...
func (MatchQuery) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchQuery) },
	}
}
...
func (MatchHeader) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchHeader) },
	}
}
...
// The host parameter should be obtained from the http.Request.Host field since
// net/http removes it from the header map.
func matchHeaders(input, against http.Header, host string, repl *kengine.Replacer) bool {
...
func (MatchHeaderRE) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchHeaderRE) },
	}
}
...
func (m *MatchHeaderRE) UnmarshalKenginefile(d *kenginefile.Dispenser) error {
	...
	for d.Next() {
		...
		if name == "" {
			name = d.GetContextString(kenginefile.MatcherNameCtxKey)
		}
...
func (MatchProtocol) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchProtocol) },
	}
}
...
func (MatchTLS) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchTLS) },
	}
}
...
func (MatchNot) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchNot) },
	}
}
...
// ParseKenginefileNestedMatcher parses the Kenginefile tokens for a nested
...
func ParseKenginefileNestedMatcherSet(d *kenginefile.Dispenser) (kengine.ModuleMap, error) {
	...
	for matcherName, tokens := range tokensByMatcherName {
		...
		if !ok {
			return nil, d.Errf("matcher module '%s' is not a Kenginefile unmarshaler", matcherName)
		}
		err = unm.UnmarshalKenginefile(kenginefile.NewDispenser(tokens))
		if err != nil {
			return nil, err
		}
...
var (
	...
	_ kenginefile.Unmarshaler = (*MatchHost)(nil)
	_ kenginefile.Unmarshaler = (*MatchPath)(nil)
	_ kenginefile.Unmarshaler = (*MatchPathRE)(nil)
	_ kenginefile.Unmarshaler = (*MatchMethod)(nil)
	_ kenginefile.Unmarshaler = (*MatchQuery)(nil)
	_ kenginefile.Unmarshaler = (*MatchHeader)(nil)
	_ kenginefile.Unmarshaler = (*MatchHeaderRE)(nil)
	_ kenginefile.Unmarshaler = (*MatchProtocol)(nil)
	_ kenginefile.Unmarshaler = (*VarsMatcher)(nil)
	_ kenginefile.Unmarshaler = (*MatchVarsRE)(nil)
