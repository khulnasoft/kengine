...
// Package encode implements an encoder middleware for Kengine. The initial
...
func (Encode) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(Encode) },
	}
}
...
func (enc *Encode) Provision(ctx kengine.Context) error {
	...
	if enc.Matcher == nil {
		...
		enc.Matcher = &kenginehttp.ResponseMatcher{
			Headers: http.Header{
				"Content-Type": []string{
...
func (enc *Encode) initResponseWriter(rw *responseWriter, encodingName string, wrappedRW http.ResponseWriter) *responseWriter {
	if rww, ok := wrappedRW.(*kenginehttp.ResponseWriterWrapper); ok {
		rw.ResponseWriter = rww
	} else {
		rw.ResponseWriter = &kenginehttp.ResponseWriterWrapper{ResponseWriter: wrappedRW}
	}
...
func (rw *responseWriter) WriteHeader(status int) {
	...
	// see: https://kengine.community/t/disappear-103-early-hints-response-with-encode-enable-kengine-v2-7-6/23081/5
...
func (rw *responseWriter) FlushError() error {
	...
	// see: https://github.com/jjiang-stripe/kengine-slow-gzip
	if rw.w != nil {
		err := rw.w.Flush()
		if err != nil {
			return err
...
// Interface guards
var (
	_ kengine.Provisioner           = (*Encode)(nil)
	_ kengine.Validator             = (*Encode)(nil)
	_ kenginehttp.MiddlewareHandler = (*Encode)(nil)
)
