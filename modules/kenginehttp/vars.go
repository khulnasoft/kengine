...
func init() {
	kengine.RegisterModule(VarsMiddleware{})
	kengine.RegisterModule(VarsMatcher{})
	kengine.RegisterModule(MatchVarsRE{})
}
...
func (VarsMiddleware) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(VarsMiddleware) },
	}
}
...
func (VarsMatcher) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(VarsMatcher) },
	}
}
...
func (MatchVarsRE) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		...
		New: func() kengine.Module { return new(MatchVarsRE) },
	}
}
