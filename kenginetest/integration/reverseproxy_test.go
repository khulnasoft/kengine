...
func TestDialWithPlaceholderUnix(t *testing.T) {
								...
								"handle": [
									{
										...
										"upstreams": [
											{
												"dial": "unix/{http.request.header.X-Kengine-Upstream-Dial}"
											}
										]
									}
								]
	...
	req.Header.Set("X-Kengine-Upstream-Dial", socketName)
...
func TestReverseProxyWithPlaceholderDialAddress(t *testing.T) {
								...
								"handle": [
									{
										...
										"upstreams": [
											{
												"dial": "{http.request.header.X-Kengine-Upstream-Dial}"
											}
										]
									}
								],
	...
	req.Header.Set("X-Kengine-Upstream-Dial", "localhost:18080")
	tester.AssertResponse(req, 200, "Hello, World!")
}
...
func TestReverseProxyWithPlaceholderTCPDialAddress(t *testing.T) {
								...
								"handle": [
									{
										...
										"upstreams": [
											{
												"dial": "tcp/{http.request.header.X-Kengine-Upstream-Dial}:18080"
											}
										]
									}
								],
	...
	req.Header.Set("X-Kengine-Upstream-Dial", "localhost")
	tester.AssertResponse(req, 200, "Hello, World!")
}
