...
// (see https://github.com/khulnasoft/kengine/issues/3556 for use case)
...
// (see https://github.com/khulnasoft/kengine/issues/3606 for use case)
	...
	tester.InitServer(` 
{
  ...
  `, "json")
	...
	// need a large body here to trigger kengine's compression, larger than gzip.miniLength
