...
func NewStaticUpstreams(c kenginefile.Dispenser, host string) ([]Upstream, error) {
...
func parseBlock(c *kenginefile.Dispenser, u *staticUpstream, hasSrv bool) error {
	var isUpstream bool
	...
	for _, host := range u.Hosts {
		...
		for _, addr := range candidates {
			...
			unhealthy := func() bool {
				...
				//      See https://github.com/khulnasoft/kengine/pull/1691
