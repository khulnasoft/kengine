...
func init() {
	kengine.RegisterPlugin("browse", kengine.Plugin{
		ServerType: "http",
		Action:     setup,
	})
}
...
func browseParse(c *kengine.Controller) ([]Config, error) {
	var configs []Config
...
@media (max-width: 600px) {
	...
	<body onload='initFilter()'>
		...
		<footer>
			Served with <a rel="noopener noreferrer" href="https://khulnasoft.com">Kengine</a>
		</footer>
		<script>
