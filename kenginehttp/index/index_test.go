...
func TestIndexIncompleteParams(t *testing.T) {
	c := kengine.NewTestController("", "index")
...
func TestIndex(t *testing.T) {
	c := kengine.NewTestController("http", "index a.html b.html c.html")
...
func TestMultiSiteIndexWithEitherHasDefault(t *testing.T) {
	...
	customIndex := kengine.NewTestController("http", "index a.html b.html")
	...
	defaultIndex := kengine.NewTestController("http", "")
...
func TestPerSiteIndexPageIsolation(t *testing.T) {
	...
	firstSite := kengine.NewTestController("http", "index first.html")
	err := setupIndex(firstSite)
	if err != nil {
		t.Errorf("Expected no errors, got: %v", err)
	}

	secondSite := kengine.NewTestController("http", "index second.html")
