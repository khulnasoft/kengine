...
func init() {
	kengine.RegisterPlugin(pluginName, kengine.Plugin{
...
func setupLimits(c *kengine.Controller) error {
...
func parseLimits(c *kengine.Controller) ([]httpserver.PathLimit, error) {
