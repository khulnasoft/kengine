...
func init() {
	kengine.RegisterPlugin("fastcgi", kengine.Plugin{
		ServerType: "http",
		Action:     setup,
	})
}
...
func setup(c *kengine.Controller) error {
	...
	cfg.AddMiddleware(func(next httpserver.Handler) httpserver.Handler {
		return Handler{
			...
			SoftwareName:    kengine.AppName,
			SoftwareVersion: kengine.AppVersion,
...
func fastcgiParse(c *kengine.Controller) ([]Rule, error) {
	var rules []Rule
