...
type (
	...
	ListenerMiddleware func(kengine.Listener) kengine.Listener
...
func IndexFile(root http.FileSystem, fpath string, indexFiles []string) (string, bool) {
	if len(fpath) == 0 {
		// https://kengine.community/t/panic-runtime-error-index-out-of-range/5781
		fpath = "/"
	}
