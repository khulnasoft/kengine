...
type SiteConfig struct {
	...
	// source Kenginefile). TODO: Enforcing this
	...
	// The path to the Kenginefile used to generate this site config
	originKenginefile string
...
func (s SiteConfig) TLSConfig() *kenginetls.Config {
	return s.TLS
}
